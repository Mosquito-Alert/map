<template>
  <div class="relative">
    ...
    <q-img src="/img/ic_full_body_off.webp" fit="contain" :height="height + 'px'">
      <!-- Body part overlays -->
      <div
        v-for="part in bodyParts.filter((part) => part.count !== undefined && part.count > 0)"
        :key="part.name"
        :style="{
...
const bodyParts = computed(() => [
  ...
  {
    name: 'leftHand',
    count: props.bite.counts.left_arm,
    left: 0.28,
    top: 0.39,
    width: 0.15,
    height: 0.15,
  ...
  {
    name: 'rightHand',
    count: props.bite.counts.right_arm,
    left: 0.62,
    top: 0.39,
    width: 0.15,
    height: 0.15,
  ...
  {
    name: 'leftLeg',
    count: props.bite.counts.left_leg,
    left: 0.37,
    top: 0.7,
    width: 0.15,
    height: 0.15,
  ...
  {
    name: 'rightLeg',
    count: props.bite.counts.right_leg,
    left: 0.525,
    top: 0.7,
    width: 0.15,
    height: 0.15,
