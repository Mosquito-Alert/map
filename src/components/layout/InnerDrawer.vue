  ...
  <div class="row">
    <div
      :class="[
        ...
        'absolute-left',
        'inner-drawer',
        { 'inner-drawer-collapsed': drawerCollapsed },
      ]"
      :style="{ width: width, 'z-index': 10 }"
    >
      <div
        :class="['full-height', 'bg-white', { 'shadow-3': !drawerCollapsed }]"
        style="transform: translateX(0px)"
      >
        <div
          class="flex q-pa-sm q-px-md bg-primary text-white items-center"
  ...
  setup(props) {
    ...
    watchEffect(() => {
      const controlsContainer = map
        ?.getViewport()
        .querySelector('.ol-overlaycontainer-stopevent') as HTMLElement | null
