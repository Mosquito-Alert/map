<template>
  <ReportsLeftDrawer
    :enabled-mosquitoes="mosquitoLayers"
    :enabled-breeding-sites="breedingSitesLayers"
    :enabled-bites="biteLayer"
    :enabled-sampling-effort="samplingEffortLayer"
    :from-date="fromDate"
    :to-date="toDate"
    :tags="tags"
    @update-layers:mosquitoes="handleMosquitoesLayerUpdate"
    @update-layers:breeding-sites="handleBreedingSitesLayerUpdate"
    @update-layers:bites="handleBitesLayerUpdate"
    @update-layers:sampling-effort="handleSamplingEffortLayerUpdate"
    @update-filters:tags="handleTagsUpdate"
    @update-filters:date="handleDateUpdate"
  />
  <ReportsMapLayer
    ref="layerRef"
    :albopictus="mosquitoLayers.includes('albopictus')"
    :aegypti="mosquitoLayers.includes('aegypti')"
    :japonicus="mosquitoLayers.includes('japonicus')"
    :koreicus="mosquitoLayers.includes('koreicus')"
    :culex="mosquitoLayers.includes('culex')"
    :unidentified-mosquito="mosquitoLayers.includes('unidentified')"
    :other-species="mosquitoLayers.includes('other')"
    :storm-drain-water="breedingSitesLayers.includes('stormDrainWater')"
    :storm-drain-dry="breedingSitesLayers.includes('stormDrainDry')"
    :other-site="breedingSitesLayers.includes('other')"
    :bites="biteLayer"
    :tags="tags"
    :from-date="fromDate"
    :to-date="toDate"
  ...
  <ReportsAnalyticsDrawer
    ...
    :stats="visibleReportStats"
  />
  <ReportsFeatureDetail
    v-if="reportMapStore.selectedReport"
    :report="reportMapStore.selectedReport"
...
watch(
  () => [
    mosquitoLayers.value,
    breedingSitesLayers.value,
    biteLayer.value,
    tags.value,
    fromDate.value,
    toDate.value,
